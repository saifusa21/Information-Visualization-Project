---
title: "CIS 671: Analysis of Breast Cancer Wisconsin (Original) Data Set"
...
plot(cm.decision_tree, main = "Decision Tree Confusion Matrix", col = c("#F8766D", "#00BA38"), sub = paste("Accuracy =", round(accuracy(cm.decision_tree), 3)))
...
#plot_NB_CM <- plot(cm.naive_bayes, main = "Naive Bayes Confusion Matrix", col = c("#F8766D", "#00BA38"), sub = paste("Accuracy =", round(accuracy(cm.naive_bayes), 3)))
...
#plot_ANN_CM <- plot(cm.ann, main = "ANN Confusion Matrix", col = c("#F8766D", "#00BA38"), 
...
#plot_SVM_CM <- plot(cm.svm, main = "SVM Confusion Matrix", col = c("#F8766D", "#00BA38"), sub = paste("Accuracy =", round(accuracy(cm.svm), 3)))
...
#plot_comp <- barplot(sbs_barplot, beside = TRUE,
...
### 2
```{r, echo=FALSE}
plot(cm.ann, main = "ANN Confusion Matrix", col = c("#F8766D", "#00BA38"), sub = paste("Accuracy =", round(accuracy(cm.ann), 3)))
```
...
```{r, echo=FALSE}
barplot(sbs_barplot, beside = TRUE,
        main="Comparison among all Models",
        col=c('#77037B', '#210062', '#009FBD', '#F9E2AF'),
        legend.text = rownames(sbs_barplot),
        args.legend = list(x = "bottomright"))
```
